...
""));
        ...
        gridLayout_2->addWidget(pushButton_24, 6, 0, 1, 1);
        ...
        gridLayout_2->addWidget(pushButton_22, 6, 3, 1, 1);
        ...
        btnMu = new QPushButton(centralwidget);
        btnMu->setObjectName("btnMu");
        sizePolicy1.setHeightForWidth(btnMu->sizePolicy().hasHeightForWidth());
        btnMu->setSizePolicy(sizePolicy1);

        gridLayout_2->addWidget(btnMu, 3, 3, 1, 1);
        ...
        btnLnverse = new QPushButton(centralwidget);
        btnLnverse->setObjectName("btnLnverse");
        sizePolicy1.setHeightForWidth(btnLnverse->sizePolicy().hasHeightForWidth());
        btnLnverse->setSizePolicy(sizePolicy1);

        gridLayout_2->addWidget(btnLnverse, 2, 0, 1, 1);
        ...
        gridLayout_2->addWidget(pushButton_21, 6, 2, 1, 1);
        ...
        display->setStyleSheet(QString::fromUtf8("font-size:18pt;\n"
""));
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "\350\256\241\347\256\227\345\231\250-\345\215\242\346\240\221\346\235\260-2023414290223", nullptr));
        ...
        btnMu->setText(QCoreApplication::translate("MainWindow", "\303\227", nullptr));
